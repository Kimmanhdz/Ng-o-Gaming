...
Closed.Image = "rbxassetid://16225571356"
16225571356''Closed.MouseButton1Down:connect(function()
...
game:GetService("Players").LocalPlayer.Idled:connect(function()
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            PageImage.Image = "rbxassetid://16225571356"
16225571356"
"..tostring(Image)
            ...
            function main:AddDropdown(text,table,callback)
                ...
                DropImage.Image = "rbxassetid://16225571356"
5012539403"
...
---------------------------------------------------------------------------Create Tab
local Ngáo Gaming= library:AddWindow("By Ngáo Gaming",Enum.KeyCode.RightControl)
local Main = SOMEXHUB:AddTab("Chính","16225571356")
